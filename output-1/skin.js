...
// Generated 周三 7月 19 18:09:20 2017
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		this._crosshair__img.setAttribute('style','position: absolute;top: 0px;left: 0px;');
	...
	function SkinHotspotClass(skinObj,hotspot) {
		...
		
		{
			...
			this._ht_node_image__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 32px;height: 32px;');
